...
export const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({ compact = false }) => {
  ...
  const renderFlag = (langCode: string, size: 'md' | 'lg', label: string) => (
    <AriaLabel label={label} className={size === 'md' ? 'text-2xl' : 'text-3xl'}>
                ...
                {supportedLanguages.map(lang => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      {renderFlag(lang.code, 'md', lang.name)}
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              initial={prefersReducedMotion ? undefined : { opacity: 0, y: -10, scale: 0.95 }}
            ...
            >
              ...
              <div className="p-2">
                {supportedLanguages.map(lang => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      {renderFlag(lang.code, 'lg', lang.name)}
                      <div className="text-left">
