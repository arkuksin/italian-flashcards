...
console.log(`   - Database User (FULL for diagnosis): ${process.env.SUPABASE_DB_USER || 'not set'}`);
console.log(`   - Database User Length: ${process.env.SUPABASE_DB_USER ? process.env.SUPABASE_DB_USER.length : 0} chars`);
console.log(`   - Database Password: ${process.env.SUPABASE_DB_PASSWORD ? '[SET]' : 'NOT SET'}`);
console.log(`   - Database Password Length: ${process.env.SUPABASE_DB_PASSWORD ? process.env.SUPABASE_DB_PASSWORD.length : 0} chars`);
